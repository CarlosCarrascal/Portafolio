...
import { ArrowRight, Github, Linkedin, Mail, MapPin, Code2, Smartphone } from "lucide-react";
  ...
  return (
    <section className="section-padding pt-32 min-h-screen flex flex-col justify-center">
      ...
      >
        ...
        <div className="md:col-span-2 md:row-span-2 glass rounded-3xl p-8 flex flex-col justify-between relative overflow-hidden group">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary/10 border border-secondary/20 text-secondary text-xs font-medium mb-6 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-2">
              Hola, soy Alexis <span className="text-muted-foreground">👋</span>
            </h1>
        ...
        {/* Tarjeta Foto / Avatar (Abstracto o tu foto) */}
        <div className="md:col-span-1 md:row-span-2 glass rounded-3xl p-4 flex items-center justify-center relative overflow-hidden card-hover group">
          {/* Aquí podrías poner una etiqueta <Image /> real */}
        ...
        {/* Tarjeta Mapa / Ubicación */}
        <div className="md:col-span-1 md:row-span-1 glass rounded-3xl p-6 flex flex-col justify-center items-start card-hover">
        ...
        <div className="md:col-span-1 md:row-span-1 glass rounded-3xl p-6 flex flex-col justify-between card-hover border-l-4 border-l-blue-500">
        ...
        <div className="md:col-span-1 md:row-span-1 glass rounded-3xl p-6 flex items-center justify-around">
        ...
        <div className="md:col-span-3 md:row-span-1 glass rounded-3xl p-8 flex items-center justify-between card-hover relative overflow-hidden">
